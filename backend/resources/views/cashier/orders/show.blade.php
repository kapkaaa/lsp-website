{{-- resources/views/cashier/orders/show.blade.php --}}
                    ...
                    <table class="table table-striped">
                        ...
                        <tfoot>
                            ...
                            <tr class="bg-light">
                                ...
                                <td class="text-right">
                                    <h5><strong>Rp {{ number_format($order->total_payment, 0, ',', '.') }}</strong></h5>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
        ...
        <div class="col-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('cashier.orders.index') }}" class="btn btn-secondary btn-block">
