                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="variantsContainer">
                            ...
                            @foreach($product->productDetails ?? collect() as $index => $variant)
                            <div class="variant-item card mb-3">
                                <div class="card-body">
                                    <!-- Di dalam loop variant yang sudah ada -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <small class="text-muted">Existing photos won’t be shown. Only new uploads will be added.</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                            ...
                            @endforeach
                            @php
                            $variantIndex = $product->productDetails->count();
                            @endphp
                            @else
                            @php
                            $variantIndex = 0;
