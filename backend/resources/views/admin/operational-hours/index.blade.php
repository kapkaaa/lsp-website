...
<div class="container-fluid">
    ...
    <!-- Current Status Card (tidak berubah) -->
    <div class="row">
        <div class="col-md-6">
                        ...
                        <li class="nav-item">
                            <span class="nav-link">
                                ...
                                <span class="float-right">
                                    @php
                                        $isOpen = \App\Models\OperationalHour::isOperational('online');
                                    @endphp
                                    @if($isOpen)
                        ...
                        <li class="nav-item">
                            <span class="nav-link">
                                ...
                                <span class="float-right text-muted">
                                    {{ \App\Models\OperationalHour::getOperationalMessage('online') }}
                                </span>
                            </span>
                        </li>
                    </ul>
        ...
        <div class="col-md-6">
            <div class="info-box bg-gradient-info">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">Online Service Hours</span>
                    <div class="progress">
                        <div class="progress-bar" style="width: 100%"></div>
                    </div>
                    <span class="progress-description">
                        Customer can order only during operational hours
                    </span>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    const table = $('#operationalHoursTable').DataTable({
        ...
        "pageLength": 10,
        "columnDefs": [
            { "orderable": false, "targets": [0, 7] },   // No & Action tidak bisa di-sort
            { "searchable": false, "targets": [0, 3, 4, 5, 6, 7] } // Kolom tertentu tidak ikut global search
        ]
    });
